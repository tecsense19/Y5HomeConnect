...
export const PANELS: Record<string, PanelDef> = {
  ...
  "arch-4m-heavy": {
    id: "arch-4m-heavy",
    category: "4M",
    label: "4M Heavy Load Switch + 4 Switch + 1 Power Switch",
    cols: 5,
    rows: 2,
    frame: { w: 500, h: 280 },
    inset: 24,
...
export const ICONS: IconDef[] = [
  { id: "ac2", label: "ac2", icon: Snowflake },
  { id: "gas", label: "Gas", icon: Flame },
  { id: "tv", label: "TV", icon: Tv },
  { id: "zona-4x", label: "Zona 4x", icon: Sparkles },
  { id: "switchicon-track-light", label: "Switchicon track light", icon: Lightbulb },
  { id: "switchicon-ceiling-hanging-light", label: "switchicon ceiling hanging light", icon: Lightbulb },
  { id: "study-light", label: "Study light", icon: Lightbulb },
  { id: "rope-light", label: "Rope light", icon: Lightbulb },
  { id: "reading-mode", label: "Reading mode", icon: BookOpen },
  { id: "night-mode", label: "Night mode", icon: Moon },
  { id: "main-door-light", label: "Main door light", icon: DoorOpen },
  { id: "magnus-2x", label: "Magnus 2x", icon: Sparkles },
  { id: "kitchen-openbox", label: "Kitchen openbox", icon: Lightbulb },
  { id: "kitchen-main-profile", label: "kitchen main profile", icon: Lightbulb },
  { id: "home-in", label: "home In", icon: Home },
  { id: "home-exit", label: "Home Exit", icon: LogOut },
  { id: "hewen-4x", label: "Hewen-4x", icon: Sparkles },
  { id: "geyser", label: "Geyser", icon: Thermometer },
  { id: "dressing-mirror", label: "dressing Mirror", icon: Monitor },
  { id: "down-light", label: "Down Light", icon: Lightbulb },
  { id: "curtains", label: "Curtains", icon: Columns },
  { id: "ac", label: "AC", icon: Snowflake },
  { id: "1-socket", label: "1-socket", icon: Plug },
  { id: "chimney", label: "Chimney", icon: Wind },
  { id: "track-light", label: "Track Light", icon: Lightbulb },
  { id: "spotlight", label: "Spotlight", icon: Lightbulb },
  { id: "scene", label: "Scene", icon: MonitorPlay },
  { id: "recessed-light2", label: "Recessed Light2", icon: Lightbulb },
  { id: "recessed-light1", label: "Recessed Light1", icon: Lightbulb },
  { id: "profile-light", label: "Profile light", icon: Lightbulb },
  { id: "power-off", label: "Power Off", icon: Power },
  { id: "night-light2", label: "Night light2", icon: Moon },
  { id: "night-light1", label: "Night light1", icon: Moon },
  { id: "light-bulb", label: "Light bulb", icon: Lightbulb },
  { id: "heavy-load", label: "Heavy load", icon: Cpu },
  { id: "hanging-light", label: "Hanging light", icon: Lightbulb },
  { id: "focus-light", label: "Focus light", icon: Lightbulb },
  { id: "fan-cum-light", label: "Fan cum light", icon: Fan },
  { id: "ceiling-fan", label: "Ceiling fan", icon: Fan },
  { id: "fan", label: "Fan", icon: Fan },
  { id: "ceiling-hanging-light", label: "Ceiling hanging light", icon: Lightbulb },
